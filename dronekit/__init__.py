...
"""
# NOTE: ARE THESE IMPORTS GROUPED FROM MOST GENERIC TO LEAST GENERIC?
...
class Parameters(MutableMapping, HasObservers):
    ...
    def add_attribute_listener(self, attr_name: str, *args: Any, **kwargs: Any) -> None:
        ...
        * `msg` - the new parameter value (so you don't need to re-query the vehicle object).
        ...
        See `vehicle_state_observing_parameters` for more information.
...
def connect(ip: str,
    ...
    Connection string parameters (`ip`) for different targets are listed in the `getting started guide <get_started_connecting>`.
    ...
    Args:
        `ip`: `Connection string <get_started_connecting>` for target address - e.g. 127.0.0.1:14550.
